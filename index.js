...
var totalNumberOfMonth = finances.length


console.log(`Total Months: ` + totalNumberOfMonth);

//Go throug the array and add all the values
...
console.log(`Average Changes: ` + averageChanges.toFixed(2));
